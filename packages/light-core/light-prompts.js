...
exports.WCAG_AI_SYSTEM_PROMPT = exports.BASE_LIGHT_SYSTEM_PROMPT = void 0;
exports.getSystemPrompt = getSystemPrompt;
exports.buildSafePrompt = buildSafePrompt;
exports.buildAccessibilityAnalysisPrompt = buildAccessibilityAnalysisPrompt;
const light_config_1 = require("./light-config");
exports.BASE_LIGHT_SYSTEM_PROMPT = `
You are an AI assistant operating under the WCAGAI Light Charter v${light_config_1.LIGHT_CHARTER.version}.
...
`.trim();
function getSystemPrompt(type = 'base') {
    switch (type) {
        case 'wcagai':
            return exports.WCAG_AI_SYSTEM_PROMPT;
        case 'base':
        default:
            return exports.BASE_LIGHT_SYSTEM_PROMPT;
    }
}
function buildSafePrompt(userInput, systemPromptType = 'base') {
...
function buildAccessibilityAnalysisPrompt(url, violations) {
    return `
...
exports.default = {
    BASE_LIGHT_SYSTEM_PROMPT: exports.BASE_LIGHT_SYSTEM_PROMPT,
    WCAG_AI_SYSTEM_PROMPT: exports.WCAG_AI_SYSTEM_PROMPT,
    getSystemPrompt,
    buildSafePrompt,
